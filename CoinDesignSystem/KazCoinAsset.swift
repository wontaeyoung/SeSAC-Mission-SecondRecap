...
public enum KazCoinAsset {
  ...
  public enum Color {
    ...
    public static let minusLabel: UIColor = .init(hex: "F04452")
    public static let minusBackground: UIColor = .init(hex: "FFEAED")
    public static let plusLabel: UIColor = .init(hex: "3282F8")
    public static let plusBackground: UIColor = .init(hex: "E5F0FF")
